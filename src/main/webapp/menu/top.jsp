              ...
              <div class="main-menu  d-none d-lg-block">
                  ...
                  <ul id="navigation">
                    ...
                    <li><a href="#">고객센터 <i
                      ...
                      <ul class="submenu">
                        ...
                        <li><a href="${root}/inquire/list.do">1:1문의</a></li>
                          <c:choose>
                            <c:when test="${sessionScope.id_admin != null}">
                              <li><a href="${root}/inquire/create.do">- 등록</a></li>
                              <li><a href="${root}/inquire/list.do?word=">- 목록</a></li>
                              <li><a href="${root}/inquire_attachfile/list.do">- 이미지 목록</a></li>
                            </c:when>
                            <c:otherwise>
                              <li><a href="${root}/inquire/create.do">-등록</a></li>
                              <li><a href="${root}/inquire/list.do?word=">-목록</a></li>
                ...
                <%--         <li><a href="${root}/faq/list.do?word=">자주묻는질문</a></li> --%>
                      ...
                      <ul class="submenu">
                        <c:choose>
                          <c:when test="${sessionScope.id_admin != null}">
                            <li><a href="${root}/notice/create.do">등록</a></li>
                            <li><a href="${root}/notice/list.do?word=">목록</a></li>
                            <li><a href="${root}/notice_attachfile/list.do">이미지 목록</a></li>
                          </c:when>
                          <c:otherwise>
                            <li><a href="${root}/notice/list.do?word=">목록</a></li>                          
                          </c:otherwise>
