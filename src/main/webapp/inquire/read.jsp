...
<script type="text/javascript">
  ...
  function panel_img(file) {
    var tag = "";
    tag   = "<A href=\"javascript: $('#inquire_attachfile_panel').hide();\">"; // 이미지 감추기
    tag += "  <IMG src='../inquire_attachfile/storage/" + file + "' style='width: 100%;'>";
    tag += "</A>";

    $('#inquire_attachfile_panel').html(tag);  // 문자열을 태그로 적용
    $('#inquire_attachfile_panel').show();      // 패널 출력
  }
