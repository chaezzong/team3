...
<meta name="viewport" content="user-scalable=yes, initial-scale=1.0, maximum-scale=3.0, width=device-width" /> 
   ...
   <script language="javascript" src="https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.3.1.min.js"></script>
    ...
    function check_jumin(){ 
      var jumins3 = $("#id_num").val() + $("#id_num_back").val(); //주민등록번호 생년월일 전달 
 ...
 <body>
  <form action="mailto:jessicasla@nate.com?subject=[s]" name="data" method="post" onsubmit="return checks()"> <!--밑에 submit 누르면 메일로 보내짐-->
      ...
      <td><input size="15" type="password" id="password"> 4~12자의 영문 대소문자와 숫자로만 입력</td>
        ...
        <td bgcolor="lightgrey" align="center">메일 주소</td>
         <td><input type="text" id="mail"> 예) id@domain.com</td>
          ...
          <td><input type="text" id="name"></td> </tr> <tr> <td colspan="2" bgcolor="lightblue" align="center"> 개인 신상 정보</td>
           </tr> 
           <tr> 
           <td bgcolor="lightgrey" align="center">주민등록번호</td>
            <td> <input size="7" type="text" id="id_num"> - <input size="7" type="password" id="id_num_back"> 예)123456-1234567 </td> 
            </tr> 
            <tr> 
            <td align="center" bgcolor="lightgrey"><b>생일</b></td>
             <td>
             <input type="text" AUTOCOMPLETE="off" name ="year" id="year" size="4" readonly disabled><b> 년</b> 
              ...
              <td bgcolor="lightgrey" align="center">관심분야</td>
               <td> <input type="checkbox" name="hobby[]" value="computer">컴퓨터
                <input type="checkbox" name="hobby[]" value="internet">인터넷
                 ...
                 </td> </tr> <tr> <td bgcolor="lightgrey" align="center">자기소개</td>
                 
                  <td>
                  <textarea cols="50" style="margin: 0px; height: 300px; width:480px" id="intro"></textarea> <!--크기 조정 가능--> 
                  </td> 
                  </tr>
                   </tbody>
                    </table>
                     ...
                     <p align="center"> <input type="submit" value="회원 가입"> <!--누르면 메일이 보내짐-->
                      <input type="reset" value="다시 입력"> <!--누르면 초기화-->
                       </p> 
                       </form> 
