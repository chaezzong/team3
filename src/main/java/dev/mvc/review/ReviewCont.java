...
public class ReviewCont {
  ...
  public String create(ReviewVO reviewVO) {
    ...
    String review_word = reviewVO.getReview_word();
    
    JSONObject json = new JSONObject();
    json.put("count",count);
    json.put("review_no",review_no); // 등록된 글의 PK 전달
    json.put("review_word",review_word); 
    
    
    System.out.println("count: " + count);
    System.out.println("review_no: " + review_no);
    System.out.println("review_word: " + review_word);
  ...
  public String read(HttpSession session, int review_no) {
    ...
    System.out.println("조회review_word: " + mem_ReviewVO.getReview_word());
   ...
   */
  @ResponseBody
  @RequestMapping(value="/review/read_by_payment_no.do", method=RequestMethod.POST,
      produces = "application/json; charset=utf-8"

      )
  public String read_by_payment_no(int payment_no) {
    
  //  System.out.println("payment_no: " + payment_no) ;
    Mem_ReviewVO mem_ReviewVO = this.reviewProc.read_by_payment_no(payment_no);
    
  //  System.out.println(mem_ReviewVO.getReview_rate());
  // System.out.println(mem_ReviewVO.getReview_word());
    
    JSONObject json = new JSONObject();
    // json.put("mem_ReviewVO", mem_ReviewVO); 
    json.put("review_rate", mem_ReviewVO.getReview_rate()); 
    json.put("review_word", mem_ReviewVO.getReview_word()); 
    return json.toString();     
  }
